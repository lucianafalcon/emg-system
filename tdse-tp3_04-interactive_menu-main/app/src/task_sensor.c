...
const task_sensor_cfg_t task_sensor_cfg_list[] = {
    ...
    {ID_BTN_ENTER, BTN_ENTER_PORT, BTN_ENTER_PIN, BTN_ENTER_PRESSED,
     DEL_BTN_XX_MAX, EV_NONE, EV_BTN_ENTER},

    {ID_BTN_STOP, BTN_STOP_PORT, BTN_STOP_PIN, BTN_STOP_PRESSED,
     DEL_BTN_XX_MAX, EV_NONE, EV_BTN_STOP},

    {ID_BTN_CALIB, BTN_CALIB_PORT, BTN_CALIB_PIN, BTN_CALIB_PRESSED,
     DEL_BTN_XX_MAX, EV_NONE, EV_BTN_CALIB}
};
